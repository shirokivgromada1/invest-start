...
components:
  ...
  - itemTitle: Оренда комунального майна
    ...
    itemNumber: '06'
    list:
      - title: 'Дорожня карта: як взяти ставок в оренду'
        location: >-
          Подання ініціативи: зацікавлена особа подає клопотання до органу
          місцевого самоврядування з проханням включити відповідний водний
          об’єкт до переліку об’єктів, які можуть бути передані в оренду через
          аукціон. Компетентний орган: повноваження з передачі у користування (в
          оренду) земельних ділянок з водними об’єктами належать обласним
          державним адміністраціям (ОДА). Підготовка до аукціону: передача в
          оренду здійснюється лише через земельні торги (аукціон). Для
          оголошення аукціону необхідні такі документи: паспорт водного об’єкта
          (погоджений з управлінням водного господарства), витяг з Державного
          земельного кадастру (за наявності сформованої ділянки), витяг з
          Державного реєстру речових прав на земельну ділянку, витяг з технічної
          документації про нормативну грошову оцінку. Умови фінансування
          підготовки: якщо паспорта водного об’єкта або нормативної грошової
          оцінки немає, їх виготовляє орган влади. Вартість документації після
          проведення аукціону відшкодовується переможцем до бюджету. Оформлення
          оренди: після проведення аукціону укладається договір оренди, який
          обов’язково погоджується з управлінням водного господарства. Лише
          після погодження договір реєструється в Державному реєстрі речових
          прав, що фіксує право користування водним об’єктом разом із земельною
          ділянкою. Роль заявника: заявник подає лише клопотання та очікує
          завершення оформлення документів органом влади (ЗОДА).
      - title: >-
